    ...
    public class Universidad
    {
        ...
        public static Universidad Leer()
        {
            try
            {
                ...
                Xml<Universidad> archivo = new Xml<Universidad>();
                archivo.Leer((Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)
                    + @"\SuarezMurray2A\Universidad.xml"), out uni);
                return uni;
            }
            catch(Exception e)
            {
        ...
        /// la clase, y los alumnos que puedan tomarla.
        /// </summary>
        /// <param name="g">Universidad</param>
        /// <param name="clase">Clase</param>
        ...
        public static Universidad operator +(Universidad u, Alumno a)
        {
            if(u != a)
            {
                ...
                //{
                //    u[i] += a;  //Agrego alumnos a las jornadas
                //}     
            }
            else
            {
